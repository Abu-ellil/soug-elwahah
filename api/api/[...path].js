/**
 * @file api/api/[...path].js - Vercel API route for all endpoints
 * @description Vercel API route that handles all API requests using Express
 */
...
const connectDB = async () => {
  try {
    ...
    await mongoose.connect(process.env.MONGODB_URI, {
      ...
      socketTimeoutMS: 4500, // 45 second socket timeout
