      ...
      >
        <View className="mx-6 mt-12">
          ...
          <View className="mb-8">
            <View className="flex-row flex-wrap gap-4">
              ...
              >
                ...
                <Text className="text-2xl font-bold text-gray-800 mb-1">{stats.totalProducts}</Text>
                <Text className="text-sm text-gray-600">المنتجات</Text>
              </TouchableOpacity>
              ...
              <TouchableOpacity className="flex-1 min-w-[45%] bg-white rounded-3xl p-6 shadow-2xl">
                ...
                <Text className="text-2xl font-bold text-gray-800 mb-1">{stats.totalOrders}</Text>
              ...
              <TouchableOpacity className="flex-1 min-w-[45%] bg-white rounded-3xl p-6 shadow-2xl">
                ...
                <Text className="text-2xl font-bold text-gray-800 mb-1">{stats.pendingOrders}</Text>
              ...
              <TouchableOpacity className="flex-1 min-w-[45%] bg-white rounded-3xl p-6 shadow-2xl">
                ...
                <Text className="text-2xl font-bold text-gray-800 mb-1">{stats.revenue} ج.م</Text>
          ...
          <View className="bg-white rounded-3xl p-6 mb-6 shadow-2xl">
            <Text className="text-xl font-bold text-gray-800 mb-6 text-right">الإجراءات السريعة</Text>
            <View className="flex-row justify-between">
              ...
              >
                ...
                <Text className="text-sm text-gray-700 font-medium">إضافة منتج</Text>
              </TouchableOpacity>
              ...
              >
                ...
                <Text className="text-sm text-gray-700 font-medium">تعديل المتجر</Text>
              </TouchableOpacity>
            </View>
          </View>
          ...
          <View className="bg-white rounded-3xl p-6 shadow-2xl">
            <Text className="text-xl font-bold text-gray-800 mb-6 text-right">الطلبات الحديثة</Text>
            <View className="gap-3">
              {recentOrders.length > 0 ? (
                recentOrders.map((order) => (
                  <TouchableOpacity key={order._id} className="flex-row justify-between items-center bg-gray-50 rounded-xl p-4">
                    <View className="items-end">
                      <Text className="text-lg font-bold text-gray-800">#{order.orderNumber || order._id.slice(-6)}</Text>
                    ...
                    <View className="items-end">
                      ...
                      <Text className="text-sm text-gray-700">{order.totalAmount} ج.م</Text>
                    </View>
                  </TouchableOpacity>
                ))
              ) : (
                <View className="items-center py-8">
                  <Text className="text-base text-gray-500">لا توجد طلبات حديثة</Text>
                </View>
              )}
            </View>
          </View>
